...
export const products: Product[] = [
  {
    id: '1',
    name: 'Slam Attax WWE Champion Card - John Cena (Rare)',
    description: 'Limited edition WWE Champion John Cena card from the 2010 Slam Attax collection. This card features John Cena in his iconic "You Can\'t See Me" pose with special holographic effects. A must-have for any WWE or Slam Attax collector!',
    price: 29.99,
